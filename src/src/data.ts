...
export const STUDY_PLAN: Module[] = [
  {
    ...
    topics: [
      ...
      },
      {
        ...
        tags: ['IP', 'Networking'],
        resources: [
          { title: 'Wikipedia: Máscara de Red y Subneteo', url: 'https://es.wikipedia.org/wiki/M%C3%A1scara_de_red', type: 'web' },
    ...
    topics: [
      {
        ...
        resources: [
          { title: 'OWASP: Guía de Pruebas de Seguridad', url: 'https://owasp.org/www-project-web-security-testing-guide/', type: 'web' },
      ...
      },
      {
        ...
        resources: [
          { title: 'Exploit-DB: Google Hacking Database', url: 'https://www.exploit-db.com/google-hacking-database', type: 'web' },
      ...
      },
      {
        ...
        resources: [
          { title: 'Documentación Oficial Metasploit', url: 'https://docs.metasploit.com/', type: 'web' },
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        tags: ['LFI', 'Backend'],
        resources: [
          { title: 'OWASP: Path Traversal y LFI', url: 'https://owasp.org/www-community/attacks/Path_Traversal', type: 'web' },
    ...
    topics: [
      {
        ...
        tags: ['AES', 'RSA'],
        resources: [
          { title: 'Cloudflare: Cifrado Asimétrico vs Simétrico', url: 'https://www.cloudflare.com/es-es/learning/ssl/what-is-asymmetric-encryption/', type: 'web' },
      ...
      },
      {
        ...
        tags: ['Hash', 'Seguridad'],
        resources: [
          { title: 'Wikipedia: Función Hash Criptográfica', url: 'https://es.wikipedia.org/wiki/Funci%C3%B3n_hash_criptogr%C3%A1fica', type: 'web' },
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        tags: ['DFIR', 'Gestión'],
        resources: [
          { title: 'CISA: Respuesta ante Incidentes', url: 'https://www.cisa.gov/topics/cyber-threats-and-advisories/federal-information-security-laws', type: 'web' },
  ...
  },
  {
    ...
    topics: [
      ...
      },
      {
        ...
        resources: [
          { title: 'Documentación Oficial Docker', url: 'https://docs.docker.com/get-started/docker-overview/', type: 'web' },
    ...
    topics: [
      {
        ...
        tags: ['Legal', 'GDPR'],
        resources: [
          { title: 'ANTAI Panamá: Protección de Datos Personales', url: 'https://www.antai.gob.pa/proteccion-de-datos-personales/', type: 'web' },
